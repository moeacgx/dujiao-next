...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.risk_email_domain_blacklisted":            "该邮箱域名已被限制注册或下单，请更换邮箱",
	...
	LocaleTW: {
		...
		"error.risk_email_domain_blacklisted":            "該郵箱域名已被限制註冊或下單，請更換郵箱",
	...
	LocaleEN: {
		...
		"error.risk_email_domain_blacklisted":            "This email domain is blocked for registration or ordering. Please use another email.",
